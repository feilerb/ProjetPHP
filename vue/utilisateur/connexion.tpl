            ...
            <div class="col-10 col-sm-8 col-md-6 col-lg-6 offset-1 offset-sm-2 offset-md-3 offset-lg-0 align-self-center d-lg-flex align-items-lg-center align-self-lg-stretch bg-white p-5 rounded rounded-lg-0 my-5 my-lg-0" id="login-block">
                <div class="m-auto w-lg-75 w-xl-50">
                    ...
                    <form action="index.php?controle=utilisateur&action=connexion" method="post">
                        <div class="form-group"><label class="text-secondary">Nom</label><input name ="nom"class="form-control" type="text" required=""  inputmode="name" value="<?php echo $nom;
                                            ?>"></div>
                        <div class="form-group"><label class="text-secondary">Mot de passe</label><input name="mdp" class="form-control" type="password" required="" value= "<?php echo $mdp;
                                            ?>"></div>
                        <button class="btn btn-info mt-2" type="submit">Se connecter&nbsp;</button>
                    </form>
                    <a href="index.php?controle=utilisateur&action=inscription"><button class="btn btn-info mt-2">S'inscrire&nbsp;</button></a>
                    <p class="mt-3 mb-0"></p>
                </div>
            </div>
